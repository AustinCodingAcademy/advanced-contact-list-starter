...
class App extends Component {
  ...
  getFilteredContacts() {
    ...
    const term = this.state.searchText.trim().toLowerCase();
      // using filter will run the state constructor seeing which values match the filter
      // for each contact we will run the check, conver to lowercase while
      // making sure it's staying in the designated index
